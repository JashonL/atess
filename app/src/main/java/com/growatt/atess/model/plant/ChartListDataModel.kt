...
data class ChartYDataList(val chartDataList: Array<Float>?, val type: String?) {
    ...
    fun getTypeName(): String? {
        return when (type) {
            ...
            "pv1" -> MainApplication.instance().getString(R.string.pv_power_1)
            "pv2" -> MainApplication.instance().getString(R.string.pv_power_2)
            "pv3" -> MainApplication.instance().getString(R.string.pv_power_3)
            "pv4" -> MainApplication.instance().getString(R.string.pv_power_4)
            "pv5" -> MainApplication.instance().getString(R.string.pv_power_5)
